...
import ru.otus.servlet.CreateClientFormServlet;
...
public class UsersWebServerSimple implements UsersWebServer {
    ...
    private void initContext() {
        ...
        sequence.addHandler(applySecurity(servletContextHandler, "/clients", "/createClientForm", "/api/client/*"));
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(
                new ServletHolder(new ClientApiServlet(dbServiceClient, gson)), "/api/client/*");
        servletContextHandler.addServlet(new ServletHolder(new CreateClientServlet(dbServiceClient)), "/createClient");
        servletContextHandler.addServlet(
                new ServletHolder(new CreateClientFormServlet(templateProcessor)), "/createClientForm");
        return servletContextHandler;
    }
}
